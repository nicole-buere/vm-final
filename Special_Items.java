...
public class Special_Items extends javax.swing.JFrame {
    ...
    public Special_Items(MoneyBoxSpecial moneyBoxSFrame) {
        ...
        SpecialItemsTableModel model = new SpecialItemsTableModel();
 ...
 int selectedRow = jTable1.getSelectedRow();
        ...
        int totalAmount = moneyBoxSFrame.getTotalAmount();
        if (totalAmount >= selectedPrice) {
            ...
            moneyBoxSFrame.setTotalAmount(0);
            moneyBoxSFrame.setChangeAmount(change);
            this.dispose();
        } else {
